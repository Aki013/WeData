...
liste_fragments.append('AT')
liste_fragments.append('G')
liste_fragments.append('CC')
liste_fragments.append('TAG')
...
for combinaison_possible in liste_combinaisons_possibles:
    #print(str(len(combinaison_possible)) + ' /' + str(longueur_brins))
    #print('   ligne - ' + combinaison_possible)
    if(len(combinaison_possible.replace(' ', '')) == longueur_brins):
         print('ligne - ' + combinaison_possible)
